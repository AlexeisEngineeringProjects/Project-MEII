...
etaN = 0.915;  % Randamentul nominal
cosFiN = 0.92; % Factorul de putere cos(fi) nominal
...
D = NaN; % Inițializare variabilă pentru diametrul interior al statorului
