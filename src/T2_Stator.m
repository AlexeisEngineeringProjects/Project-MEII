...
switch p
    case 1
        a1_comm(2) = a1_comm(2) + "2";
    case 2
        a1_comm(2) = a1_comm(2) + "4";
    case 3
        a1_comm(2) = a1_comm(2) + "6";
    case 4
        a1_comm(2) = a1_comm(2) + "8";
    otherwise
        disp("[ ERROR ] p out of range! Check initial values.")
end

a1 = UserGet(a1_comm, a1_space, a1_default, opts);
clear("a1_comm", "a1_space", "a1_default")
%----------------------------------------------------------------------
