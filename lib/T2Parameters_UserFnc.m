function [q1, a1, J1, iz, kw1, Bd1, ku, bistm1, histm1, hpana, giz, nf] = T2Parameters_UserFnc(p)
    ...
    switch p
        ...
        case 2
            ...
            default_values = {'5', '4', '5.3', '0.04', '0.922', '1.7', '0.75', '3.25', '1.8', '3', '0.4', '10'};
        case 3
            promt(1) = promt(1) + "(3 ... 5)";
            promt(2) = promt(2) + "6";
            promt(3) = promt(3) + "from (4.5 ... 5) [A/mm^{2}]";

            default_values = {'4', '3', '4.8', '0.04', '0.922', '1.7', '0.75', '3.25', '1.8', '3', '0.4', '10'};
        case 4
            promt(1) = promt(1) + "(2 ... 4)";
            promt(2) = promt(2) + "8";
            promt(3) = promt(3) + "from (4 ... 5.5) [A/mm^{2}]";

            default_values = {'3', '4', '4.75', '0.04', '0.922', '1.7', '0.75', '3.25', '1.8', '3', '0.4', '10'};
        otherwise
